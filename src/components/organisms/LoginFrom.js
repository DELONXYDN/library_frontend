    ...
    return (
        <div className="w-full">
            ...
            <div className="flex justify-center mb-6">
                <div className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-sm ${isAdminPath ? 'bg-amber-100 text-amber-600' : 'bg-indigo-100 text-indigo-600'
                    }`}>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
                ...
                <button
                    disabled={loading}
                    className={`w-full py-4 rounded-2xl font-black text-[11px] tracking-[0.2em] flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95 ${loading
