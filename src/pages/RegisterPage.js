                ...
                <div className="relative">
                    ...
                    <div className="bg-white p-10 md:p-12 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-50 backdrop-blur-sm">
                        ...
                        <form onSubmit={handleRegister} className="space-y-4">
                            ...
                            <button
                                disabled={loading}
                                className={`w-full py-4 rounded-2xl font-black text-[11px] tracking-[0.2em] flex items-center justify-center gap-3 shadow-xl transition-all active:scale-95 mt-4 ${loading
